...
/**
 * Install a post type for videos.
 *
 * @package    Tradecast
 * @subpackage Tradecast/public
 * @author     Kiener Digital Commerce <support@kiener.nl>
 */
class Tradecast_PostType_Video
{
    /**
     * Registers the post type for videos.
     *
     * @since 1.0.0
     * @access public
     */
    ...
    {
        register_post_type('tradecast-videos', $this->get_options());
    }
    ...
    {
        // registers a meta field for the video id
        register_meta('post', '_tradecast_video_id', [
            'object_subtype' => 'tradecast-videos',
            'type' => 'integer',
            'single' => true,
            'show_in_rest' => true,
        ]);

        // registers a meta field for the video embed url
        register_meta('post', '_tradecast_video_embed_url', [
            'object_subtype' => 'tradecast-videos',
            'type' => 'string',
            'single' => true,
            'show_in_rest' => true,
        ...
        // registers a meta field for the video thumbnail url
        register_meta('post', '_tradecast_video_thumbnail_url', [
            'object_subtype' => 'tradecast-videos',
            'type' => 'string',
            'single' => true,
            'show_in_rest' => true,
        ...
        // registers a meta field for the video created at date
        register_meta('post', '_tradecast_video_created_at', [
            'object_subtype' => 'tradecast-videos',
            'type' => 'string',
            'single' => true,
            'show_in_rest' => true,
        ...
        // registers a meta field for whether the video is inaccessible
        register_meta('post', '_tradecast_video_is_inaccessible', [
            'object_subtype' => 'tradecast-videos',
            'type' => 'boolean',
            'single' => true,
            'show_in_rest' => true,
    ...
    {
        return [
            'label' => __('Video', TRADECAST_TEXT_DOMAIN),
            'description' => __('Video description', TRADECAST_TEXT_DOMAIN),
    ...
    {
        return [
            'name' => _x('Videos', 'Videos', TRADECAST_TEXT_DOMAIN),
            'singular_name' => _x('Video', 'Video', TRADECAST_TEXT_DOMAIN),
            'menu_name' => __('Videos', TRADECAST_TEXT_DOMAIN),
            'name_admin_bar' => __('Video', TRADECAST_TEXT_DOMAIN),
            ...
            'all_items' => __('All Videos', TRADECAST_TEXT_DOMAIN),
            'add_new_item' => __('Add New', TRADECAST_TEXT_DOMAIN),
            'add_new' => __('New Video', TRADECAST_TEXT_DOMAIN),
